...
#' an \code{NxK} matrix of autoregressive slope coefficients and parameters on deterministic terms in \eqn{X}.
#' 
...
#' The conditional variance of the \eqn{n}th shock at time \eqn{t} is given by:
