...
#' 
#' The structural shocks, \code{U}, are temporally and contemporaneously independent 
...
#'
#' @seealso \code{\link{specify_bsvar}}, \code{\link{specify_bsvar_msh}}, \code{\link{specify_bsvar_mix}}, \code{\link{specify_bsvar_sv}}, \code{\link{normalise}}
#'
