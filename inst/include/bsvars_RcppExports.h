...
namespace bsvars {
    ...
    inline arma::cube forecast_sigma2_msh(arma::cube& posterior_sigma2, arma::cube& posterior_PR_TR, arma::vec& S_T, const int horizon) {
        ...
        if (p_forecast_sigma2_msh == NULL) {
            validateSignature("arma::cube(*forecast_sigma2_msh)(arma::cube&,arma::cube&,arma::vec&,const int)");
    ...
    inline arma::cube forecast_sigma2_sv(arma::vec& posterior_h_T, arma::mat& posterior_rho, arma::mat& posterior_omega, const int horizon, const bool centred_sv = FALSE) {
        ...
        if (p_forecast_sigma2_sv == NULL) {
            validateSignature("arma::cube(*forecast_sigma2_sv)(arma::vec&,arma::mat&,arma::mat&,const int,const bool)");
