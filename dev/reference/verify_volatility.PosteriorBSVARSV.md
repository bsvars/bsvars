...
restriction: \$\$H_0: \omega_n = 0\$\$ The logarithm of Bayes factor for
this hypothesis can be computed using the SDDR as the difference of
...
point: \$\$log p(\omega_n = 0 \| data) - log p(\omega_n = 0)\$\$
Therefore, a negative value of the difference is the evidence against
homoskedasticity of the structural shock. The estimation of both
